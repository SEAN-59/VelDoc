...
지금은 API 명세서 작성기부터 시작합니다. 이후 개발 과정에서 자주 필요한 문서 에디터를 하나씩 더해갈 예정입니다.
...
VelDoc은 거대한 문서 시스템보다 가벼운 작성 흐름을 지향합니다. 필요한 문서를 빠르게 만들고, 팀이 같은 형식으로 읽고 관리할 수 있도록 차분하게 다듬어갑니다.
